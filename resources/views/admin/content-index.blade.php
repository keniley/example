            ...
            columns: [
                { 
                    ...
                    template: function(row) {
                        return '<a href="/admin/content/' + row.id + '">' + row.id + '</a>';
                    }
                },
                { 
                    column: 'active', 
                    ...
                    template: function(row) {
                        if(row.active) {
                            return '<a href="/admin/content/' + row.id + '"><i class="fas fa-check text-success"></i></a>';
                        }
                        return '<a href="/admin/content/' + row.id + '"><i class="fas fa-times text-danger"></i></a>';
                    }
                },
                { 
                    column: 'title', 
                    ...
                    width: 75,
                    template: function(row) {
                        return '<a href="/admin/content/' + row.id + '">'+row.title+'</a>';
                    } 
                }
            ],
            endpoint: {
...
@section ('breadcrumb')
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb justify-content-center bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page">Seznam textů na webu</li>
      </ol>
    </nav>
@endsection
    ...
    <div class="col col-12">
        <div class="panel bg-white p-4">
            <div class="panel-header border-0 mb-3 pb-3 d-flex justify-content-between">
                <h2 class="p-0 m-0">Texty na webu<small class="d-inline-block ml-2"></small></h2>
                <div class="d-flex">
                    <button data-toggle="modal" data-target="#modal-l" data-content="/admin/modal/new/content" type="button" class="btn btn-success btn-sm btn-circle materialize waves-circle-light"><i class="icon fas fa-plus"></i></button>
